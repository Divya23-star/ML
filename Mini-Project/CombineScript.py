...
train_path = "assignment-1-ml-algorithm-avengers/Mini-Project/UCI HAR Dataset/train"
test_path = "assignment-1-ml-algorithm-avengers/Mini-Project/UCI HAR Dataset/test"
